...
//Runs path generator ofr testing
function runPathFinder(x, y, length) {
var gamegrid = new Grid(x,y); //grid size
reset(gamegrid);
var array = generatePath(gamegrid, length); //length of path
return array;
}